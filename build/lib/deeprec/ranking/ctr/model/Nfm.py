...
from ..layer.common_layer import fm, dnn
from ..utils.utize import cal_feature_number, get_linear_embedding, get_embedding, get_sequence_embedding


class Nfm(object):

    def __init__(self, feature_config_dict, embedding_size=8, l2_reg_linear=0.00001,
                 dnn_hidden_units=[40, 20],task='binary'):
        ...
        # nfm part
        nfm_out = fm(self.sprase_data_embedding)  # bs * es

        out = tf.concat([nfm_out, self.sprase_data_linear_embedding], axis=1)
