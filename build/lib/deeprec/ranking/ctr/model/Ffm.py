...
from ..layer.common_layer import ffm
from ..utils.utize import cal_feature_number, get_linear_embedding, get_embedding, get_sequence_embedding

class Ffm(object):

    def __init__(self, feature_config_dict, embedding_size=3, l2_reg_linear=0.00001,task='binary'):
        ...
        ffm_out = ffm(self.inputs, self.number_of_sprase_feature, embedding_size, self.feature_config_dict)

        out = tf.concat([self.sprase_data_linear_embedding, ffm_out], axis=1)
