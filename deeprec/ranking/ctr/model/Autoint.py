...
from ..layer.common_layer import transfomer
...
class Autoint(object):
    ...
    def __init__(self, feature_config_dict, embedding_size=8, l2_reg_linear=0.00001, att_layer_num=3,
                 head_num=2, att_embedding_size=8, use_res=True, task='binary'):
        """
        ...
        for i in range(att_layer_num):
            out = transfomer(self.sprase_data_embedding, head_num, att_embedding_size, use_res, name = i)
