...
from ..layer.common_layer import dnn, fm
from ..utils.utize import cal_feature_number, get_linear_embedding, get_embedding, get_sequence_embedding


class DeepFm(object):

    def __init__(self, feature_config_dict, embedding_size=8, l2_reg_linear=0.00001,dnn_hidden_units=(40, 20),
        ...
        #deep part
        deepfm_out = dnn(out, dnn_hidden_units)
        deepfm_out = tf.layers.dense(deepfm_out, 10)
        out = tf.concat([out, deepfm_out], axis = 1)
