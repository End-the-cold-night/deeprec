...
from ..layer.common_layer import ccpm
...
class Ccpm(object):
    ...
    def __init__(self, feature_config_dict, embedding_size=3, l2_reg_linear=0.00001,
                 conv_kernel_width=(2, 1), conv_filters=(4, 4), task='binary'):
        ...
        #ccpm part
        ccpm_out = ccpm(self.sprase_data_embedding, conv_kernel_width, conv_filters)


        out = tf.concat([ccpm_out, self.sprase_data_linear_embedding], axis =1)
