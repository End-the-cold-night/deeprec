...
from ..layer.common_layer import afm
from ..utils.utize import cal_feature_number, get_linear_embedding, get_embedding, get_sequence_embedding


class Afm(object):

    def __init__(self, feature_config_dict, embedding_size=8,  attention_size = 8, l2_reg_linear=0.00001,
                 task='binary'):
        """
        ...
        # AFM part
        afm_out = afm(self.sprase_data_embedding, attention_size)
        out = tf.concat([self.sprase_data_linear_embedding, afm_out], axis=1)
