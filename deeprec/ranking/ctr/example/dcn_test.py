...
from deeprec.ranking.ctr import Dcn
...
def _eval(sess, model):
  ...
  if best_auc < test_gauc:
    best_auc = test_gauc
    model.save(sess, 'save_dcn_path/ckpt')
  pickle.dump(all_result, open("auc_dcn_all_result.pkl","wb"))
  return None
