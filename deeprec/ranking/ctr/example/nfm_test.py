...
from deeprec.ranking.ctr import Nfm
...
def _eval(sess, model):
  ...
  if best_auc < test_gauc:
    best_auc = test_gauc
    model.save(sess, 'save_nfm_path/ckpt')
  pickle.dump(all_result, open("auc_nfm_all_result.pkl","wb"))
  return None
