...
from deeprec.ranking.ctr import Pnn
...
def _eval(sess, model):
  ...
  if best_auc < test_gauc:
    best_auc = test_gauc
    model.save(sess, 'save_pnn_path/ckpt')
  pickle.dump(all_result, open("auc_pnn_all_result.pkl","wb"))
  return None
